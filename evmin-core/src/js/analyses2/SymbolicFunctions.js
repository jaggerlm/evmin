(function() {
	...
	var sfuns = {};
    sfuns.string_indexOf = function(result, str, startPos) {
    ...
    sfuns.string_lastIndexOf = function(result, str, startPos) {
        var reg = new RegExp(".*"+regex_escape(str)+".*");
        var ret = J$.readInput(result,true);
    ...
    sfuns.string_charCodeAt = function(result, idx) {
        var ret = J$.readInput(result,true);
    ...
    sfuns.string_substring = function(result, start, end) {
    ...
    sfuns.string_substr = function(result, start, length) {
    ...
    sfuns.string_charAt = function(result, start) {
    ...
    sfuns.builtin_parseInt = function(result, s) {
        var ret = J$.readInput(result,true);
    ...
    sfuns.object_getField = function(result, base, offset) {
