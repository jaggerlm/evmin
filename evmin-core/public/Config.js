...
// make MAX_BUF_SIZE slightly less than 2^16, to allow over low-level overheads
	...
	/******* instrumenting config ******/
	function extend(base,setting){
	...
	//key is the regex to ignore a varible accessed by:  base.offset
	Config.ignoreInst = {
		'eval':{
			args:false,  // args will be instrumented
			code:[0]   // list arguments that should be treated as code
		},
		'setTimeout':{
			args:false,
			code:[0]
