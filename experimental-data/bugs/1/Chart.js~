...
(function(){
	...
	var each = helpers.each = function(loopable,callback,self,idex,flag){
	...
	var	amd = helpers.amd = (typeof root.define == 'function' && root.define.amd);
		//-- Math methods
...
(function(){
	...
	Chart.Type.extend({
		...
		eachBars : function(callback, flag){
			helpers.each(this.datasets,function(dataset, datasetIndex){
				helpers.each(dataset.bars, callback, this, datasetIndex,true);
			},this);
		},
